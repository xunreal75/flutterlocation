...
@property(nonatomic, strong, nullable) NSNumber * pigeonLocationPermission;
@end
...
- (void)openLocationSettingsWithCompletion:(void (^)(NSNumber *_Nullable, FlutterError *_Nullable))completion;
...
@protocol LocationPermissionsHostApi
/// @return `nil` only when `error != nil`.
- (nullable PigeonLocationPermissionData *)getLocationPermissionStatusWithError:(FlutterError *_Nullable *_Nonnull)error;
- (void)requestLocationPermissionPermission:(PigeonLocationPermission)permission completion:(void (^)(PigeonLocationPermissionData *_Nullable, FlutterError *_Nullable))completion;
@end

extern void LocationPermissionsHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<LocationPermissionsHostApi> *_Nullable api);
