...
class PigeonLocationPermissionData {
  ...
  static PigeonLocationPermissionData decode(Object result) {
    ...
    return PigeonLocationPermissionData(
      pigeonLocationPermission: result[0] as int?,
    );
  }
}
...
class LocationHostApi {
  ...
  Future<PigeonLocationData> getLocation(
    ...
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.location2_platform_interface.LocationHostApi.getLocation',
        codec,
  ...
  Future<bool> setLocationSettings(PigeonLocationSettings arg_settings) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.location2_platform_interface.LocationHostApi.setLocationSettings',
        codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_settings]) as List<Object?>?;
  ...
  Future<int> getPermissionStatus() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.location2_platform_interface.LocationHostApi.getPermissionStatus',
        codec,
        binaryMessenger: _binaryMessenger);
  ...
  Future<int> requestPermission() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.location2_platform_interface.LocationHostApi.requestPermission',
        codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList = await channel.send(null) as List<Object?>?;
    if (replyList == null) {
  ...
  Future<bool> isGPSEnabled() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.location2_platform_interface.LocationHostApi.isGPSEnabled',
        codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList = await channel.send(null) as List<Object?>?;
    if (replyList == null) {
  ...
  Future<bool> isNetworkEnabled() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.location2_platform_interface.LocationHostApi.isNetworkEnabled',
        codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList = await channel.send(null) as List<Object?>?;
    if (replyList == null) {
  ...
  Future<bool> changeNotificationSettings(
    ...
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.location2_platform_interface.LocationHostApi.changeNotificationSettings',
        codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_settings]) as List<Object?>?;
  ...
  Future<bool> setBackgroundActivated(bool arg_activated) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.location2_platform_interface.LocationHostApi.setBackgroundActivated',
        codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
  ...
  Future<bool> openLocationSettings() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.location2_platform_interface.LocationHostApi.openLocationSettings',
        codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList = await channel.send(null) as List<Object?>?;
    if (replyList == null) {
  ...
  Future<bool> openAppSettings() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.location2_platform_interface.LocationHostApi.openAppSettings',
        codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList = await channel.send(null) as List<Object?>?;
    if (replyList == null) {
...
class _LocationPermissionsHostApiCodec extends StandardMessageCodec {
  const _LocationPermissionsHostApiCodec();
  @override
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is PigeonLocationPermissionData) {
      buffer.putUint8(128);
      writeValue(buffer, value.encode());
    } else {
      super.writeValue(buffer, value);
...
class LocationPermissionsHostApi {
  /// Constructor for [LocationPermissionsHostApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  LocationPermissionsHostApi({BinaryMessenger? binaryMessenger})
      : _binaryMessenger = binaryMessenger;
  final BinaryMessenger? _binaryMessenger;

  static const MessageCodec<Object?> codec = _LocationPermissionsHostApiCodec();

  Future<PigeonLocationPermissionData> getLocationPermissionStatus() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.location2_platform_interface.LocationPermissionsHostApi.getLocationPermissionStatus',
        codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList = await channel.send(null) as List<Object?>?;
    if (replyList == null) {
  ...
  Future<PigeonLocationPermissionData> requestLocationPermission(
      PigeonLocationPermission arg_permission) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.location2_platform_interface.LocationPermissionsHostApi.requestLocationPermission',
        codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
