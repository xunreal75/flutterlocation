...
class LocationPermissionsHostApi {
  ...
  Future<PigeonLocationPermissionData> getLocationPermissionStatus() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.LocationPermissionsHostApi.getLocationPermissionStatus', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(null) as List<Object?>?;
    if (replyList == null) {
  ...
  Future<PigeonLocationPermissionData> requestLocationPermission(PigeonLocationPermission arg_permission) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.LocationPermissionsHostApi.requestLocationPermission', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
