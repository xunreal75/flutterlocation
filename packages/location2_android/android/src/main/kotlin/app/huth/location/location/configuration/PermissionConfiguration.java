...
public class PermissionConfiguration {
    ...
    public static class Builder {
        ...
        private String rationaleMessage = app.huth.location.location.configuration.Defaults.EMPTY_STRING;
        private String[] requiredPermissions = app.huth.location.location.configuration.Defaults.LOCATION_PERMISSIONS;
