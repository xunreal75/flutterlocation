...
public class DefaultLocationProvider extends LocationProvider
    ...
    private app.huth.location.location.providers.locationprovider.DefaultLocationSource defaultLocationSource;
    ...
    public void runScheduledTask(@NonNull String taskId) {
        if (taskId.equals(app.huth.location.location.providers.locationprovider.DefaultLocationSource.PROVIDER_SWITCH_TASK)) {
            getSourceProvider().getUpdateRequest().release();
    ...
    // For test purposes
    public void setDefaultLocationSource(app.huth.location.location.providers.locationprovider.DefaultLocationSource defaultLocationSource) {
        this.defaultLocationSource = defaultLocationSource;
    }

    private app.huth.location.location.providers.locationprovider.DefaultLocationSource getSourceProvider() {
        if (defaultLocationSource == null) {
            defaultLocationSource = new app.huth.location.location.providers.locationprovider.DefaultLocationSource(getContext(), this, this);
        }
