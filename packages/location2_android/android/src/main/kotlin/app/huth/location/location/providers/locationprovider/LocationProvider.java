...
public abstract class LocationProvider {
    ...
    /**
     * This method is called immediately once the LocationProvider is set to {@linkplain LocationManagerLoc2}
     */
    @CallSuper
    ...
    protected boolean startActivityForResult(Intent intent) {
        if (getActivity() != null) {
            getActivity().startActivityForResult(intent, app.huth.location.location.constants.RequestCode.GPS_ENABLE);
        } else {
