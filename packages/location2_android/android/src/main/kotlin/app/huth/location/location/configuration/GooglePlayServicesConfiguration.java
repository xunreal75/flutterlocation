...
public class GooglePlayServicesConfiguration {
    ...
    public static class Builder {
        ...
        private LocationRequest locationRequest = app.huth.location.location.configuration.Defaults.createDefaultLocationRequest();
        private boolean fallbackToDefault = app.huth.location.location.configuration.Defaults.FALLBACK_TO_DEFAULT;
        private boolean askForGooglePlayServices = app.huth.location.location.configuration.Defaults.ASK_FOR_GP_SERVICES;
        private boolean askForSettingsApi = app.huth.location.location.configuration.Defaults.ASK_FOR_SETTINGS_API;
        private boolean failOnSettingsApiSuspended = app.huth.location.location.configuration.Defaults.FAIL_ON_SETTINGS_API_SUSPENDED;
        private boolean ignoreLastKnowLocation = app.huth.location.location.configuration.Defaults.IGNORE_LAST_KNOW_LOCATION;
        private long googlePlayServicesWaitPeriod = app.huth.location.location.configuration.Defaults.WAIT_PERIOD;

        /**
         * LocationRequest object that you specified to use while getting location from Google Play Services
         * Default is {@linkplain app.huth.location.location.configuration.Defaults#createDefaultLocationRequest()}
         */
