...
import app.huth.location.location.providers.locationprovider.GooglePlayServicesLocationSource.SourceListener;
...
public class GooglePlayServicesLocationProvider extends LocationProvider implements SourceListener {
    ...
    private app.huth.location.location.providers.locationprovider.GooglePlayServicesLocationSource googlePlayServicesLocationSource;
    ...
    // For test purposes
    void setDispatcherLocationSource(app.huth.location.location.providers.locationprovider.GooglePlayServicesLocationSource googlePlayServicesLocationSource) {
        this.googlePlayServicesLocationSource = googlePlayServicesLocationSource;
    }

    private app.huth.location.location.providers.locationprovider.GooglePlayServicesLocationSource getSourceProvider() {
        if (googlePlayServicesLocationSource == null) {
            googlePlayServicesLocationSource = new app.huth.location.location.providers.locationprovider.GooglePlayServicesLocationSource(getContext(),
