package app.huth.location.location.configuration;
...
import app.huth.location.location.constants.ProviderType;
import app.huth.location.location.helper.StringUtils;
import app.huth.location.location.providers.dialogprovider.DialogProvider;
import app.huth.location.location.providers.dialogprovider.SimpleMessageDialogProvider;
...
public class DefaultProviderConfiguration {
    ...
    public static class Builder {
        ...
        private long requiredTimeInterval = app.huth.location.location.configuration.Defaults.LOCATION_INTERVAL;
        private long requiredDistanceInterval = app.huth.location.location.configuration.Defaults.LOCATION_DISTANCE_INTERVAL;
        private float acceptableAccuracy = app.huth.location.location.configuration.Defaults.MIN_ACCURACY;
        private long acceptableTimePeriod = app.huth.location.location.configuration.Defaults.TIME_PERIOD;
        private long gpsWaitPeriod = app.huth.location.location.configuration.Defaults.WAIT_PERIOD;
        private long networkWaitPeriod = app.huth.location.location.configuration.Defaults.WAIT_PERIOD;
        private DialogProvider gpsDialogProvider;
        private String gpsMessage = app.huth.location.location.configuration.Defaults.EMPTY_STRING;
         ...
         * {@linkplain app.huth.location.location.configuration.LocationConfiguration#keepTracking()} is set to true.
         * Default is {@linkplain app.huth.location.location.configuration.Defaults#LOCATION_INTERVAL}
         */
         ...
         * Default is {@linkplain app.huth.location.location.configuration.Defaults#LOCATION_DISTANCE_INTERVAL}
         */
         ...
         * Default is {@linkplain app.huth.location.location.configuration.Defaults#MIN_ACCURACY}
         */
         ...
         * Default is {@linkplain app.huth.location.location.configuration.Defaults#TIME_PERIOD}
         */
