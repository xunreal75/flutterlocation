...
import app.huth.location.location.providers.permissionprovider.StubPermissionProvider;
...
public class LocationConfiguration {
    ...
    public static class Builder {
        ...
        private boolean keepTracking = app.huth.location.location.configuration.Defaults.KEEP_TRACKING;
