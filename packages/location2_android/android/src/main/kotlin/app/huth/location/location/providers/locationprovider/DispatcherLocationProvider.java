...
import app.huth.location.location.providers.locationprovider.DispatcherLocationSource;
...
public class DispatcherLocationProvider extends app.huth.location.location.providers.locationprovider.LocationProvider implements ContinuousTaskRunner, FallbackListener {

    private Dialog gpServicesDialog;
    private app.huth.location.location.providers.locationprovider.LocationProvider activeProvider;
    private app.huth.location.location.providers.locationprovider.DispatcherLocationSource dispatcherLocationSource;
    ...
    public void runScheduledTask(@NonNull String taskId) {
        if (taskId.equals(app.huth.location.location.providers.locationprovider.DispatcherLocationSource.GOOGLE_PLAY_SERVICE_SWITCH_TASK)) {
    ...
    // For test purposes
    void setDispatcherLocationSource(app.huth.location.location.providers.locationprovider.DispatcherLocationSource dispatcherLocationSource) {
        this.dispatcherLocationSource = dispatcherLocationSource;
    }

    private app.huth.location.location.providers.locationprovider.DispatcherLocationSource getSourceProvider() {
        if (dispatcherLocationSource == null) {
            dispatcherLocationSource = new app.huth.location.location.providers.locationprovider.DispatcherLocationSource(this);
        }
