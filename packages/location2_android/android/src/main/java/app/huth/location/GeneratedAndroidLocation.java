...
public class GeneratedAndroidLocation {
  ...
  public static final class PigeonLocationPermissionData {
    private @Nullable Long pigeonLocationPermission;

    public @Nullable Long getPigeonLocationPermission() {
      return pigeonLocationPermission;
    }

    public void setPigeonLocationPermission(@Nullable Long setterArg) {
    ...
    public static final class Builder {
      ...
      public @NonNull Builder setPigeonLocationPermission(@Nullable Long setterArg) {
        this.pigeonLocationPermission = setterArg;
        return this;
      }
    ...
    ArrayList<Object> toList() {
      ...
      toListResult.add(pigeonLocationPermission);
      return toListResult;
    }
    ...
    static @NonNull PigeonLocationPermissionData fromList(@NonNull ArrayList<Object> list) {
      ...
      pigeonResult.setPigeonLocationPermission((pigeonLocationPermission == null) ? null : ((pigeonLocationPermission instanceof Integer) ? (Integer) pigeonLocationPermission : (Long) pigeonLocationPermission));
      return pigeonResult;
    }
  }
  ...
  public interface LocationHostApi {
    ...
    void openLocationSettings(@NonNull Result<Boolean> result);

    void openAppSettings(@NonNull Result<Boolean> result);
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable LocationHostApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.location2_platform_interface.LocationHostApi.getLocation", getCodec());
        if (api != null) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.location2_platform_interface.LocationHostApi.setLocationSettings", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.location2_platform_interface.LocationHostApi.getPermissionStatus", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.location2_platform_interface.LocationHostApi.requestPermission", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.location2_platform_interface.LocationHostApi.isGPSEnabled", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.location2_platform_interface.LocationHostApi.isNetworkEnabled", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.location2_platform_interface.LocationHostApi.changeNotificationSettings", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.location2_platform_interface.LocationHostApi.setBackgroundActivated", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.location2_platform_interface.LocationHostApi.openLocationSettings", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                api.openLocationSettings(resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.location2_platform_interface.LocationHostApi.openAppSettings", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                api.openAppSettings(resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
  ...
  private static class LocationPermissionsHostApiCodec extends StandardMessageCodec {
    public static final LocationPermissionsHostApiCodec INSTANCE = new LocationPermissionsHostApiCodec();

    private LocationPermissionsHostApiCodec() {}
    ...
    @Override
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      if (value instanceof PigeonLocationPermissionData) {
        stream.write(128);
  ...
  /** Generated interface from Pigeon that represents a handler of messages from Flutter. */
  public interface LocationPermissionsHostApi {

    @NonNull 
    PigeonLocationPermissionData getLocationPermissionStatus();

    void requestLocationPermission(@NonNull PigeonLocationPermission permission, @NonNull Result<PigeonLocationPermissionData> result);

    /** The codec used by LocationPermissionsHostApi. */
    static @NonNull MessageCodec<Object> getCodec() {
      return LocationPermissionsHostApiCodec.INSTANCE;
    }
    /**Sets up an instance of `LocationPermissionsHostApi` to handle messages through the `binaryMessenger`. */
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable LocationPermissionsHostApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.location2_platform_interface.LocationPermissionsHostApi.getLocationPermissionStatus", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.location2_platform_interface.LocationPermissionsHostApi.requestLocationPermission", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                Result<PigeonLocationPermissionData> resultCallback =
                    new Result<PigeonLocationPermissionData>() {
                      public void success(PigeonLocationPermissionData result) {
                        wrapped.add(0, result);
                        reply.reply(wrapped);
                      }
                ...
                api.requestLocationPermission(permissionArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
